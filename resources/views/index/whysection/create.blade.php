...
<div class="card-body">
    ...
    <form action="{{ route('whysection.store') }}" method="POST">
        @csrf
                ...
                <div class="mb-3">
                    ...
                    class="form-control @error('sub_title') is-invalid @enderror">{{ old('sub_title') }}</textarea>
